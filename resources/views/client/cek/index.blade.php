<x-admin-layout>
    <x-slot name="title">Cek Alat, Bahan & Ruangan</x-slot>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($alat->status == 'Tersedia')
                                                                    <span class="badge bg-primary">{{ $alat->status }}
                                                                    </span>
                                                                @else
                                                                    <span class="badge bg-warning">{{ $alat->status }}
                                                                    </span>
                                                                @endif
                                                            </td>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body py-2">
                            ...
                            <p class="card-text m-0 p-0">Stok: <span class="badge bg-success">{{ $bahan->stock }}
                                    {{ $bahan->unit }}</span></p>
